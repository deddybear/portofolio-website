export default function AboutComponent({yearCount, completedProjectCount, techDomainCount} : PropsAboutComponent) {
    ...
    return (
        <div>
            ...
            <p className="text-justify text-gray-600 mt-10 tracking-wide lg:w-xl lg:mt-15 lg:mb-15">
            ...
            <div className="grid grid-cols-1 gap-10 items-start lg:grid-cols-12 lg:gap-14 ">
                ...
                <div className="lg:col-span-7 flex flex-col gap-8">
                    <div className="grid sm:grid-cols-2 gap-6 lg:gap-4">
                        <div className="flex flex-col gap-2 shadow-lg bg-white border border-line rounded-xl p-5
                      transition-all duration-300 hover:-translate-y-1 hover:border-indigo hover:shadow-[0_12px_28px_-16px_rgb(20_28_58/0.35)]">
                            <span className="w-8 h-8 rounded-lg bg-indigo-soft text-indigo flex items-center justify-center">
