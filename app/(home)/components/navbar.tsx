    ...
    return (
        <nav className="relative after:pointer-events-none after:absolute">
            <div className="mx-auto">
                <div className="relative flex items-center justify-between border-3 border-blue-500">
                    {/* Mobile Menu Button Start */}
                    <div className="absolute inset-y-0 right-0 flex items-center sm:hidden border-2 border-red-500">
                    ...
                    {/* Logo Webiste Start */}
                    <div className="flex flex-1 items-center sm:items-stretch sm:justify-start border-2 border-red-500">
                        <a href="#" className="block py-6 font-bold">Ini Logo</a>
                    </div>
                    {/* Logo Webiste End */}

                    {/* Item Navbar Start */}
                    <div className="hidden sm:block border-2 border-red-500">
